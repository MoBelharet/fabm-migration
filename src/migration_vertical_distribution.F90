...
module migration_vertical_distribution
...
type, extends(type_base_model), public :: type_migration_vertical_distribution
...
contains
   ...
   subroutine initialize(self, configunit)
      class (type_migration_vertical_distribution), intent(inout), target :: self
   ...
   subroutine do(self, _ARGUMENTS_DO_)
    class (type_migration_vertical_distribution), intent(in) :: self
