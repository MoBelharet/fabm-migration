...
module migration_weight_distribution
...
type, extends(type_base_model), public ::type_migration_weight_distribution
...
subroutine depth_integral_initialize(self, configunit)
    class (type_migration_weight_distribution), intent(inout), target :: self
...
subroutine depth_integral_do_column(self, _ARGUMENTS_DO_COLUMN_)
    class (type_migration_weight_distribution), intent(in) :: self
